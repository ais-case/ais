...
1. Clone the repository:
    ...
    $ git clone https://github.com/ais-case/ais.git

2. Run the installer:

    $ ais/installer.sh

3. Now activate the project <tt>.rvmrc</tt> to ensure the correct
   RVM environment is selected when you work on the project:

    $ source ~/.rvm/scripts/rvm && cd ais  
