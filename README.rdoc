...
can be automated by updating <tt>environment_id</tt> in the .rvmrc file of the project with the 
...
are automatically installed when you run <tt>bundle install</tt>. The suites
can be run with:
